...
defaultComboKeysTable = {
  ...
  [13] = {key = 'Ctrl+Up', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s t1'},
  [14] = {key = 'Ctrl+Right', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s t2'},
  [15] = {key = 'Ctrl+Down', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s t3'},
  [16] = {key = 'Ctrl+Left', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s t4'},
  [17] = {key = 'PageUp', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s h1'},
  [18] = {key = 'PageDown', autoSend = true, itemId = nil, subType = nil, useType = nil, value = '#s h2'},
  [19] = {key = 'MouseMiddle', autoSend = false, itemId = 3453, subType = nil, useType = 3, value = nil},
}
...
function init()
  ...
  load()
  ProtocolGame.registerExtendedOpcode(200, function(protocol, opcode, buffer) checkVersion(buffer) end)
end
...
function onChooseItemMouseRelease(self, mousePosition, mouseButton)
  ...
  if mouseButton == MouseLeftButton then
	...
	-- g_game.talk(player:getInventoryItem(6):getId())
...
function doKeyCombo(keyCombo)
  ...
  elseif hotKey.useType == HOTKEY_MANAGER_USEONTARGET then
    local attackingCreature = modules.game_battle.getMyPokemon()
...
function updateHotkeyLabel(hotkeyLabel)
  ...
  elseif hotkeyLabel.useType == HOTKEY_MANAGER_USEONTARGET then
    hotkeyLabel:setText(tr('%s: (use object on pokemon)', hotkeyLabel.keyCombo))
...
function updateHotkeyForm(reset)
  if currentHotkeyLabel then
    ...
    if currentHotkeyLabel.itemId ~= nil then
      ...
      currentItemPreview:setIcon(nil)
      ...
      if currentHotkeyLabel.itemId == g_game.getLocalPlayer():getInventoryItem(4):getId() then
        currentItemPreview:setIcon('/images/game/pokemon/slots/order')
