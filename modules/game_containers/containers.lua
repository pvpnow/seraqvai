function init()
  ...
  inventoryButton = modules.game_inventory.getInventoryButton()
...
function onContainerOpen(container, previousContainer)
  ...
  containerItemWidget:setIcon(nil)

  if name == 'Pokebag' then
    containerItemWidget:setIcon('/images/topbuttons/miniwindowicon/inventory')
    containerItemWidget:setMarginLeft(3)
    containerWindow:setTextOffset('20 5')
...
function onContainerClose(container)
  destroy(container)
  if container:getName() == 'Pokebag' then
